...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='C:/tensorflow/inception/output_graph1.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--output_labels',
      type=str,
      default='C:/tensorflow/inception/output_labels1.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str, 
      default='C:/tensorflow/inception/retrain_logs',
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='C:/tensorflow/inception/imagenet',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='C:/tensorflow/inception/bottleneck',
