...
export STREAMER_PATH=$HOME/mjpg/mjpg-streamer
...
$STREAMER_PATH/mjpg_streamer -i "input_uvc.so -d /dev/video0 -y -r 320x240 -f 20"  -o "output_http.so -w $STREAMER_PATH/www"
